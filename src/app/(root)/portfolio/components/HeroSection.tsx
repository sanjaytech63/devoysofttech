      ...
      <Container className="relative z-10">
        ...
        >
          <h1 className="heading-section leading-tight text-center md:text-left">
            200+ Projects.
            <br />
            <span className="text-gradient-green">Stories of Growth.</span>
          </h1>

          <p className="text-paragraph text-center md:text-left">
            From Jaipur startups to international brands — every project built
            with logic, creativity, and dedication.
          </p>
        </div>
      </Container>
